(function() {
  ...
  module.exports = function(sequelize, DataTypes) {
    ...
    Event = sequelize.define("Event", {
      ...
      tableName: "events",
      classMethods: {
        addOrder: function(loadout, callback = function() {}) {
          var data;
          data = {
            type: "add_order",
            loadout: loadout,
        ...
        addCancelOrder: function(loadout, callback = function() {}) {
          var data;
          data = {
            type: "cancel_order",
            loadout: loadout,
        ...
        findNext: function(type = null, callback = function() {}) {
          var query;
          query = {
            where: {
        ...
        findNextValid: function(callback = function() {}) {
          var query;
          query = {
            where: {
              status: MarketHelper.getEventStatus("pending"),
