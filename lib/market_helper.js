(function() {
  var EVENT_STATUS, EVENT_TYPE, FEE, MARKET_STATUS, MarketHelper, ORDER_ACTIONS, ORDER_STATUS, ORDER_TYPES, PAYMENT_STATUS, TOKENS, TRANSACTION_ACCEPTED_CATEGORIES, WALLET_STATUS, _, exports, marketSettings, math;
  ...
  MarketHelper = {
    ...
    getExchangeMarketsId: function(exchange) {
      var id, marketType, marketsId, ref;
      marketsId = [];
      ref = marketSettings.AVAILABLE_MARKETS;
      for (marketType in ref) {
        id = ref[marketType];
    ...
    isValidExchange: function(exchange) {
      var i, len, market, ref;
      ref = this.getMarketTypes();
